...
exports.calculateScoringResult = calculateScoringResult;
const DELAY_MS = 500;
function delay(ms) {
    return new Promise(resolve => setTimeout(resolve, ms));
}
async function scoreAnswers(rows, client, options) {
...
function calculateScoringResult(rows, passThreshold) {
